...
const Button = forwardRef(({ 
  ...
  const buttonTextStyle = variant === 'primary' ? buttonStyles.primaryButtonText : buttonStyles.secondaryButtonText;
  
  const disabledStyle = disabled || loading ? buttonStyles.primaryButtonDisabled : {};
